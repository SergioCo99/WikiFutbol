...
public class TeamOfTheYear_view {
	 ...
	 * @param id_jugador - id de uno de los jugadores que forma el equipo del año
	 * @param nombre_jugador - nombre de uno de los jugadores que forma el equipo del año
	 * @param posicion - posición de uno de los jugadores que forma el equipo del año
	 * @param voto_jugador - votos que ha recivido uno de los jugadores que forma el equipo del año
	 * @param goles_jugador -  goles que ha marcado uno de los jugadores que forma el equipo del año
	 */
