...
public class TeamOfTheYear_viewTest {
	...
	public void metodoToString() {
		...
		assertEquals("TeamOfTheYear_view [id_teamoftheyear=2, id_jugador=2, nombre_jugador=Kenan Kodro, posicion_jugador=Delantero, voto_jugador=0, goles_jugador=0]", t.toString());
	}
}
