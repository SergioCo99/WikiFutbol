...
public class FeedbackTest {
	...
	@Before
	public void setUp() {
		f = new Feedback(1, "a", Valoracion.CINCO, Recomendacion.si, "Correcto");
	}
	...
	public void testValoracion() {
		f.setValoracion(Valoracion.CINCO);
		assertEquals(Valoracion.CINCO, f.getValoracion());
	}
	...
	public void metodoToString() {
		...
		assertEquals(
				"Feedback [id=1, usuario=a, valoracion=CINCO, recomendacion=si, opinion=Correcto]",
				f.toString());
	}
}
