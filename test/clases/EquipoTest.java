...
public class EquipoTest {
	...
	public void metodoToString() {
		...
		assertEquals("Equipo [id=1, nombre=Athletic Club, ciudad=Bilbao, estadio=San Mamés, anyoCreacion=1898, palmares=2 Ligas, entrenador=Gaizka Garitano]", a.toString());
	}
