...
public class EstadisticaFeedbackTest {
	...
	// test de metodo privado, NO se borra hasta saber si se deberia hacer o no
	/*
	 * @Test public void testMediaPuntuacion() { double a = 4; double b = 2;
	 * 
	 * if (b == 0) { fail("No puedes dividir por cero"); }
	 * 
	 * double expected = EstadisticaFeedback.mediaPuntuacion(4, 2); double actual =
	 * a / b; double delta = 0; assertEquals(expected, actual, delta); }
	 */

	// test de metodo privado, NO se borra hasta saber si se deberia hacer o no
	/*
	 * @Test public void testSiNO() { double a = 6; double b = 4; double c = 10;
	 * 
	 * if (c == 0) { fail("No puedes dividir por cero"); } else if (a + b != c) {
	 * fail("Deberia que dar la suma"); }
	 * 
	 * double ans1 = (a / c) * 100; double ans2 = (b / c) * 100;
	 * 
	 * ArrayList<Double> arr = new ArrayList<>(); arr.add(0, ans1); arr.add(1,
	 * ans2);
	 * 
